...
$(function(){
	...
	$('.nav_li').eq(1).hover(function(){
		...
		hovertimer2=setTimeout(function(){$(".xl_out").slideDown("slow");},300);},function(){
	...
	$(".xl_out").hover(function(){
		clearTimeout(hovertimer);},function(){
		hovertimer=setTimeout(function(){$(".xl_out").slideUp("slow");
			},300);});
	$('.nav_lis').hover(function(){$(this).find("ul").show();$(this).find(".nav_lia").addClass("nav_liah");},function(){
		$(this).find("ul").hide();$(this).find(".nav_lia").removeClass("nav_liah");
		});
	})
